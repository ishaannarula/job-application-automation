...
create_jobsdf('Arrowstreet Capital', 'https://arrowstreetcapital.wd5.myworkdayjobs.com/en-US/Arrowstreet')

#baindf = create_jobsdf('Bain Capital', 'https://baincapital.wd1.myworkdayjobs.com/External_Public')
#baindf['Date Viewed'] = datetime.now()
#baindf.to_excel('Dataframes/' + 'Bain Capital.xlsx')
